...
namespace CreateUser.SSBService {
    ...
    public interface ISSBService {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/ISSBService/ssn", ReplyAction="http://tempuri.org/ISSBService/ssnResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        
        CreateUser.SSBService.ssnResponse Endssn(System.IAsyncResult result);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    [System.ServiceModel.MessageContractAttribute(WrapperName="ssn", WrapperNamespace="http://tempuri.org/", IsWrapped=true)]
    public partial class ssnRequest {
        ...
        public ssnRequest(string sessionValue) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    [System.ServiceModel.MessageContractAttribute(WrapperName="ssnResponse", WrapperNamespace="http://tempuri.org/", IsWrapped=true)]
    public partial class ssnResponse {
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://tempuri.org/", Order=0)]
        public long ssnResult;
        
        public ssnResponse() {
        }
        
        public ssnResponse(long ssnResult) {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ssnCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        public ssnCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    public partial class SSBServiceClient : System.ServiceModel.ClientBase<CreateUser.SSBService.ISSBService>, CreateUser.SSBService.ISSBService {
        ...
        private BeginOperationDelegate onBeginssnDelegate;
        
        private EndOperationDelegate onEndssnDelegate;
        
        private System.Threading.SendOrPostCallback onssnCompletedDelegate;
        ...
        public event System.EventHandler<ssnCompletedEventArgs> ssnCompleted;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
            return base.Channel.Beginssn(request, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private System.IAsyncResult BeginLookup(string sessionValue, System.AsyncCallback callback, object asyncState) {
            CreateUser.SSBService.ssnRequest inValue = new CreateUser.SSBService.ssnRequest();
            inValue.sessionValue = sessionValue;
            return ((CreateUser.SSBService.ISSBService)(this)).Beginssn(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CreateUser.SSBService.SessionResponse CreateUser.SSBService.ISSBService.EndLookup(System.IAsyncResult result) {
            return base.Channel.EndLookup(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private long EndSession(System.IAsyncResult result) {
            CreateUser.SSBService.upSessionResponse retVal = ((CreateUser.SSBService.ISSBService)(this)).Endssn(result);
            return retVal.SessionResult;
        }
        
        private System.IAsyncResult OnBeginssn(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string sessionValue = ((string)(inValues[0]));
            return this.Beginssn(sessionValue, callback, asyncState);
        }
        
        private object[] OnEndssn(System.IAsyncResult result) {
            long retVal = this.Endssn(result);
            return new object[] {
                    retVal};
        }
        
        private void OnssnCompleted(object state) {
            if ((this.ssnCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.ssnCompleted(this, new ssnCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void ssnAsync(string sessionValue) {
            this.ssnAsync(sessionValue, null);
        }
        
        public void ssnAsync(string sessionValue, object userState) {
            if ((this.onBeginssnDelegate == null)) {
                this.onBeginssnDelegate = new BeginOperationDelegate(this.OnBeginssn);
            }
            if ((this.onEndssnDelegate == null)) {
                this.onEndssnDelegate = new EndOperationDelegate(this.OnEndssn);
            }
            if ((this.onssnCompletedDelegate == null)) {
                this.onssnCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnssnCompleted);
            }
            base.InvokeAsync(this.onBeginssnDelegate, new object[] {
                        sessionValue}, this.onEndssnDelegate, this.onssnCompletedDelegate, userState);
        }
        ...
        private class SSBServiceClientChannel : ChannelBase<CreateUser.SSBService.ISSBService>, CreateUser.SSBService.ISSBService {
            ...
            public System.IAsyncResult Beginssn(CreateUser.SSBService.ssnRequest request, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = request;
                System.IAsyncResult _result = base.BeginInvoke("ssn", _args, callback, asyncState);
                return _result;
            }
            
            public CreateUser.SSBService.ssnResponse Endssn(System.IAsyncResult result) {
                object[] _args = new object[0];
                CreateUser.SSBService.ssnResponse _result = ((CreateUser.SSBService.ssnResponse)(base.EndInvoke("ssn", _args, result)));
                return _result;
            }
